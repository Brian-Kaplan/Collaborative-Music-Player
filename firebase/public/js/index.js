(function (jQuery, Firebase, Path) {
    ...
    var rootRef = new Firebase('https://collabplayer.firebaseio.com');
    ...
    function handleAuthResponse(promise, route) {
        $.when(promise).then(function (authData) {
            ...
            createCookie('USER_UID',authData.uid,7)
            // route
            routeTo(route);
    ...
    controllers.login = function (form) {
        ...
        form.on('submit', function (e) {
            ...
            handleAuthResponse(loginPromise, 'main.html');
    ...
    controllers.register = function (form) {
        ...
        form.on('submit', function (e) {
            ...
            data["credits"] = 0
            userRef.child(user.uid).set(data, function onComplete() {
